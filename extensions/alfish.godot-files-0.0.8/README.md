...
![Screenshot of godot-files extension for VSCode on a tscn file, showing syntax-coloring, outline and hover preview feature](https://github.com/AlfishSoftware/godot-files-vscode/raw/v0.0.8/docs/showcase-gdasset.webp)
...
- Syntax-coloring of embedded code in asset strings for GDScript and Godot Shader resources (see image above).  
	...
	![Showcasing how embedded code escape sequences are handled gracefully](https://github.com/AlfishSoftware/godot-files-vscode/raw/v0.0.8/docs/showcase-embedded-code-escapes.webp)

- Navigate to definition of `SubResource` and `ExtResource` references, and to resource paths.  
	![Showcasing navigate to definition](https://github.com/AlfishSoftware/godot-files-vscode/raw/v0.0.8/docs/showcase-goto-definition.png)  
...
- Hover resource references or paths to show code for loading in GDScript (`preload(…)`, `load(…)` or `FileAccess.open(…)`).  
	![Showcasing code for loading when previewing user path](https://github.com/AlfishSoftware/godot-files-vscode/raw/v0.0.8/docs/showcase-user-path-load.webp)
...
- Hover image and font resource paths or their `ExtResource` references to preview them directly.  
	...
	![Showcasing image preview](https://github.com/AlfishSoftware/godot-files-vscode/raw/v0.0.8/docs/showcase-image-preview.png)  
	...
	![Showcasing font preview](https://github.com/AlfishSoftware/godot-files-vscode/raw/v0.0.8/docs/showcase-font-preview.webp)  
...
- Hover any resource (except sub-resources) to preview its thumbnail as generated by the Godot Editor.  
	...
	It works for scenes:  
	![Showcasing thumbnail preview of a scene](https://github.com/AlfishSoftware/godot-files-vscode/raw/v0.0.8/docs/showcase-scene-thumb.webp)
	
	As well as any other resource files that have a thumbnail in Godot Editor:  
	![Showcasing thumbnail preview of a material resource](https://github.com/AlfishSoftware/godot-files-vscode/raw/v0.0.8/docs/showcase-material-thumb.webp)
...
- **🌟 NEW FEATURE (NO LONGER RESTRICTED): 🌟**  
	...
	![Showcasing inline color decorators](https://github.com/AlfishSoftware/godot-files-vscode/raw/v0.0.8/docs/showcase-color-decorators.webp)  
...
- Inlay hints surrounding items with implied parentheses in packed arrays of vectors or colors.  
	...
	![Showcasing implied parentheses in array items as inlay hints](https://github.com/AlfishSoftware/godot-files-vscode/raw/v0.0.8/docs/showcase-parentheses-hint-in-arrays.webp)
...
- Browse the online Godot Documentation directly from the IDE.  
	...
	![Showcasing a Godot Docs tutorial page on the internal webview](https://github.com/AlfishSoftware/godot-files-vscode/raw/v0.0.8/docs/showcase-docs-webview-tutorial.webp)
