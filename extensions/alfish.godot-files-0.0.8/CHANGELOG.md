...
Features currently in [early access](https://github.com/AlfishSoftware/godot-files-vscode/blob/v0.0.8/README.md#early-access) are marked with 🔒 as they're restricted to supporters.  
